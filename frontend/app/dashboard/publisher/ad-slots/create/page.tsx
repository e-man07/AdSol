      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="space-y-6">
          <div className="bg-gray-800 p-6 rounded-lg shadow-lg">
            ...
            <ul className="space-y-3 text-gray-300">
              <li className="flex gap-2">
                ...
                <span>
                  Set competitive prices based on your audience size and
                  engagement
                </span>
              </li>
              <li className="flex gap-2">
              ...
              <li className="flex gap-2">
                <span className="text-blue-400 font-bold">•</span>
                <span>
                  Provide accurate audience size data for better targeting
                </span>
              </li>
              <li className="flex gap-2">
                <span className="text-blue-400 font-bold">•</span>
                <span>
                  Use descriptive slot IDs to help advertisers identify
                  placement
                </span>
              </li>
              <li className="flex gap-2">
                <span className="text-blue-400 font-bold">•</span>
                <span>
                  All transactions are on-chain and require wallet signature
                </span>
              </li>
            </ul>
          </div>
          ...
          <div className="bg-gray-800 p-6 rounded-lg shadow-lg">
            ...
            <p className="text-gray-300 mb-4">Average prices by category:</p>
